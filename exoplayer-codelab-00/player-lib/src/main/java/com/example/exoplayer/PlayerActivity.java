...
//    }
    ...
    private class ComponentListener extends ExoPlayer.DefaultEventListener implements VideoRendererEventListener, AudioRendererEventListener {

        public final String TAG = ComponentListener.class.getName() + "_tag";
        @Override
